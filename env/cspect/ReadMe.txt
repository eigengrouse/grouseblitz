...
G <bank>:<offset>       Goto address in physical memory using bank/offset
...
PWRITE <address>        Toggle a Physical Memory WRITE access break point
PWRITE <bank>:<offset>  Toggle a Physical Memory WRITE access break point
